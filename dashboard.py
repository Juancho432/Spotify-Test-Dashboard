...
metrics = [
    ...
    {
        "label": "Tasa de Éxito de Integración",
        "value": 75,
        "meta": 90,
        "meta_label": "Meta: > 90%",
        "unit": "%",
        "higher_is_better": True,
        "formula": "(6 exitosos / 8 ejecutados) × 100"
    },
    {
        "label": "Tasa de Éxito de Regresión",
        "value": 100,
        "meta": 90,
        "meta_label": "Meta: > 90%",
        "unit": "%",
        "higher_is_better": True,
        "formula": "(8 exitosos / 8 ejecutados) × 100"
    },
    {
        "label": "Tasa de Éxito Funcional",
        "value": 100,
        "meta": 90,
        "meta_label": "Meta: > 90%",
        "unit": "%",
    ...
    },
    {
        ...
        "value": 120,
        "meta": 30,
        "meta_label": "Meta: < 30 seg",
        "unit": " seg",
        "higher_is_better": False,
        "formula": "Segundos en completar el flujo de registro"
    },
    {
        "label": "Tiempo Medio de Sincronización",
        "value": 1.5,
        "meta": 5,
        "meta_label": "Meta: < 5 seg",
        "unit": " seg",
        "higher_is_better": False,
        "formula": "Segundos en transferir reproducción entre dispositivos"
    },
    {
        "label": "Clics para Reproducir una Canción",
        "value": 3,
        "meta": 5,
        "meta_label": "Meta: < 5 clics",
        "unit": " clics",
        "higher_is_better": False,
        "formula": "Conteo de clics desde inicio hasta reproducción"
    },
]
...
<div class="main-header">
    ...
    <h1>Dashboard de Métricas de Calidad</h1>
    <p>13 métricas · 40 casos de prueba</p>
    <p>Integrantes: Melissa Betancur, Sofia Betancur, Sebastian Echeverri, Juan Manuel Jaramillo, Emmanuel Mora</p<
</div>
""", unsafe_allow_html=True)
...
fig.update_layout(
    ...
    xaxis=dict(
        tickfont=dict(size=9, color="#b3b3b3"),
        gridcolor="#2a2a2a",
        linecolor="#2a2a2a",
        tickangle=-35,
    ),
